...
export default {
  ...
  computed: {
    ...mapState(useFakeStore,["projectsHeading", "projectsDescription", "projects"]),

    filteredProjects() {
      console.log('==============================',this.projects,this.projectsHeading);
  ...
  methods: {
    ...mapActions(useFakeStore, {
      actionGetNumber: "getNumber",
    }),
  ...
  mounted() {
    console.log(this.actionGetNumber());
